...
def taumBday(b, w, bc, wc, z):
    ...
    cost_without_conversion = b * bc + w * wc

    # Calculate the cost of buying all black gifts and converting some to white
    cost_with_conversion = b * bc + w * (bc + z)

    # Calculate the cost of buying all white gifts and converting some to black
    cost_with_conversion_reverse = b * (wc + z) + w * wc

    # Return the minimum cost among the three possibilities
    return min(cost_without_conversion, cost_with_conversion, cost_with_conversion_reverse)
