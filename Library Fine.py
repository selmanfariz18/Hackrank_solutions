...
def libraryFine(d1, m1, y1, d2, m2, y2):
    ...
    if y1 < y2 or (y1 == y2 and m1 < m2) or (y1 == y2 and m1 == m2 and d1 <= d2):
        # The book is returned on or before the expected return date.
        fine = 0
    elif y1 == y2 and m1 == m2:
        # The book is returned within the same month and year, but after the expected return date.
        fine = 15 * (d1 - d2)
    elif y1 == y2 and m1 > m2:
        # The book is returned after the expected return month but within the same year.
        fine = 500 * (m1 - m2)
    else:
        # The book is returned after the calendar year in which it was expected.
        fine = 10000
