...
def dayOfProgrammer(year):
    ...
    if year == 1918:
        # Special case for 1918 when the transition from Julian to Gregorian calendar happened
        return "26.09.1918"
    elif (year < 1918 and year % 4 == 0) or \
         (year > 1918 and ((year % 400 == 0) or (year % 4 == 0 and year % 100 != 0))):
        # Check if the year is a leap year in either Julian or Gregorian calendar
        return f"12.09.{year}"
    else:
        # For non-leap years, the 256th day is September 13th
        return f"13.09.{year}"
